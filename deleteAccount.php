					...
					<section id="wrapper">
						<header>
							<div class="inner">
								...
								<p>Delete paragon cinema's member account.</p>
							</div>
						</header>
						...
						<!-- Content -->
							<div class="wrapper">
								<div class="inner" id="form">
									...
									<h3 class="major" >ENTER PASSWORD TO DELETE YOUR ACCOUNT</h3>
									<section>
										<form method="post" action="deleteAccountEngine.php">
											<div class="row uniform">
												...
												<div class="12u$" align="left">
													<hr>
													<ul class="actions" >
														<li><input type="submit" value="Delete" class="special" id="deleteAccount" name="deleteAccount" /></li>
													</ul>
												</div>
											</div>
										</form>
